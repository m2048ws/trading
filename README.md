...
fee-policy composition and scenario-owned attribution, and risk are separate physical pure boundaries. Actual
execution remains a pure leaf with no production consumer in its first Slice; later accepted Slices may add
effect-polymorphic application ports, concrete runtime interpreters, and versioned codecs without moving domain
authority out of `trading-execution-lifecycle`. The current RFC-0002 S-04 delivery owns

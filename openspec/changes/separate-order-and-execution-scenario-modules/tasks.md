...
- [ ] 1.1 Confirm Proposals 0–9 are complete and approved for ordered application and that Proposals 0–4 have landed
  before editing order/scenario production code.
- [ ] 1.2 Refresh Git/OpenSpec state and record clean formatting, compilation, unit/property tests, and external-artifact
...
- [ ] 8.5 Run strict validation for this and all active OpenSpec changes and reconcile any artifact drift.
- [ ] 8.6 Prepare the validated worktree for fresh independent review without self-certifying, committing, archiving, or
  beginning Proposal 6 outside steward authorization.

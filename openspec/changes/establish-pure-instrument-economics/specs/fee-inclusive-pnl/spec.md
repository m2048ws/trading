...
#### Scenario: Inspect order mechanics only in policy
...
#### Scenario: Construct a taker charge from a typed amount
...
#### Scenario: Construct a maker rebate from a typed amount
...
#### Scenario: Preserve fee rounding conservation
...
#### Scenario: Reject a foreign denomination
...
#### Scenario: Reject foreign PnL components
...
#### Scenario: Re-evaluate identical pure inputs
...
#### Scenario: Change a scenario assumption upstream
...
#### Scenario: Preserve explicit contribution scope

...
Proposal 1 intentionally removes quantity-owned packed records because they are unversioned logical values tied to a
mutable registry, while the later domain proposals correctly refuse to treat in-memory proof-carrying values as wire
